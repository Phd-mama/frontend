...
const ProfileEditForm: React.FC<Props> = ({ userId, onClose, onReload }) => {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case "Avatar":
        return <AvatarUploadForm userId={userId} onAvatarUploaded={(newAvatarUrl) => setFormData((prev) => ({ ...prev, profile_picture: newAvatarUrl }))} />;
      default:
        return null;
    }
  };
